...
from app.domain.user.controllers.user_controller import UserList, UserProfile
...
from app.domain.patient.controllers.evaluation_controller import (
    PatientMedicalRecordEvaluationsExport,
)
...
routes = {
    ...
    "/patients/evaluations/export": PatientMedicalRecordEvaluationsExport,
